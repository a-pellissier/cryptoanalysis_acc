...
def coin_data_extractor(year_start, month_start, day_start, year_end, month_end, day_end):
    #This is the main api url
    base_url = "http://api.coingecko.com/api/v3"

    #We start by reading all the desired coins, and storing that in a list
...
if __name__ == "__main__":
    coin_data_extractor(int(sys.argv[1]),int(sys.argv[2]),int(sys.argv[3]),int(sys.argv[4]),int(sys.argv[5]),int(sys.argv[6]))